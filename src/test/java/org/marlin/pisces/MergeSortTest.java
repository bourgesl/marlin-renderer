...
public class MergeSortTest {
    ...
    final static boolean TEST_HIGH_UNSORTED = false;
    ...
    public static void main(String[] args) {
        ...
        final ArraySortDataCollection adc = ArraySortDataCollection.load(
                TEST_PATH + "ArraySortDataCollection_th40.ser"
        //                TEST_PATH + "ArraySortDataCollection_th60.ser"
        );
        ...
        for (int n = 0; n < N; n++) {
            ...
            for (int j = 0; j < JOBS; j++) {
                ...
                for (int i = POS; i < size; i++) {
                    ...
                    mergeSortNoCopy(x, y, auxX, auxY, toIndex, sortedIndex);
