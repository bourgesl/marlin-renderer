 ...
 * for paths made of either 4 quads, 2 cubics (random)
 * Note: Use the argument -slow to run more intensive tests (too much time)
 *
 * @run main/othervm/timeout=300 -Dsun.java2d.renderer=sun.java2d.marlin.MarlinRenderingEngine BetterCurveShapeTest -cubic
...
public final class BetterCurveShapeTest {
    ...
    // constants:
    static final boolean DO_FAIL = Boolean.valueOf(System.getProperty("BetterCurveShapeTest.fail", "true"));
    ...
    static final int TESTW = 200;
    static final int TESTH = 200;
    ...
    static final double RAND_SCALE = 1.5;
    ...
    static final AtomicBoolean isSubdCurveRuntime = new AtomicBoolean();
        ...
        log.addHandler(new Handler() {
            ...
            public void publish(LogRecord record) {
                ...
                if (msg != null) {
                    ...
                    if (msg.startsWith("sun.java2d.renderer.betterCurves.runtime.enable")) {
                        isSubdCurveRuntime.set(msg.contains("true"));
                    }
                }
    ...
    private static void resetOptions() {
        NUM_TESTS = Integer.getInteger("BetterCurveShapeTest.numTests", 5000);
    ...
    public static void main(String[] args) {
        {
            ...
            if (!isSubdCurveRuntime.get()) {
                throw new RuntimeException("Marlin curve subdivision not enabled at runtime !");
            }
        }

        System.out.println("---------------------------------------");
        System.out.println("BetterCurveShapeTest: image = " + TESTW + " x " + TESTH);
...
/*
    ...
    private static void paintShape(final Shape p2d, final Graphics2D g2d,
                                   final boolean fill, final boolean subdivideCurves) {
        reset(g2d);

        setSubdivideCurves(g2d, subdivideCurves);
    ...
    private static void setSubdivideCurves(final Graphics2D g2d, final boolean subdivide) {
        // Enable antialiasing:
        g2d.setRenderingHint(RenderingHints.KEY_ANTIALIASING,
